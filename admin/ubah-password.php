                ...
                <div class="box-body">
                    ...
                    <form action="" method="POST">
                       ...
                       <div class="form-group">
                           ...
                           <input type="password" name="pass1" placeholder="Password" class="
                           input-control" required>
                       </div>   

                       <div class="form-group">
                           <label>Ulangi Password</label>
                           <input type="password" name="pass2" placeholder="Ulangi Password" class="
                           input-control"  required>
                       </div>  
                    ...
                    <?php
                       ...
                       if(isset($_POST['submit'])) {
                        ...
                        $pass1  = addslashes(ucwords($_POST['pass1']));
