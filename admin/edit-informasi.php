            ...
            <div class="box">
                ...
                <form action="" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            <label>Judul</label>
                            <input type="text" name="judul" placeholder="Judul" value="<?= $p->judul ?>" class="
                            input-control" required>
                        </div>   
 
                        <div class="form-group">
                            <label>Keterangan</label>
                            <textarea name="keterangan" class="input-control" placeholder="Keterangan" id="textarea"><?= $p->keterangan?></textarea>
                        </div>  
                    ...
                    <?php
                       ...
                       if(isset($_POST['submit'])) {
                            ...
                            if($_FILES['gambar']['name']!= '') {
                                ...
                                $allowedtype = array('png', 'jpg', 'jpeg', 'gif', 'jfif');

                                if(!in_array($formatfile, $allowedtype)) {
                                    echo '<div class="alert alert-error">Format file tidak diizinkan</div>';
                                    return false;
                                }elseif($filesize > 1000000){
                                    echo '<div class="alert alert-error">Ukuran File melebihi batas maksimal upload</div>';
                                    return false;
                                }else{
